...
.field private mSavedNativePointer:I
...
.method private constructor <init>(Landroid/webkit/WebViewClassic;I)V
    ...
    const-string v2, "HTML5VideoViewProxy::initialize mNativePointer "
    ...
    .line 731
    iput p2, p0, Landroid/webkit/HTML5VideoViewProxy;->mSavedNativePointer:I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v7, "Play() mNativePointer "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Landroid/webkit/HTML5VideoViewProxy;->mNativePointer:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, " mSavedNativePointer "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Landroid/webkit/HTML5VideoViewProxy;->mSavedNativePointer:I
    ...
    .line 463
    iget v5, p0, Landroid/webkit/HTML5VideoViewProxy;->mNativePointer:I

    if-nez v5, :cond_2

    .line 464
    iget v5, p0, Landroid/webkit/HTML5VideoViewProxy;->mSavedNativePointer:I

    iput v5, p0, Landroid/webkit/HTML5VideoViewProxy;->mNativePointer:I
    ...
    .line 489
    iput-boolean v8, p0, Landroid/webkit/HTML5VideoViewProxy;->mIsBuffering:Z
    ...
    .line 524
    iput-boolean v9, p0, Landroid/webkit/HTML5VideoViewProxy;->mIsBuffering:Z
...
.method public onKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    const-string/jumbo v2, "onKey call exit "
...
.method public teardown()V
    ...
    const-string/jumbo v3, "teardown::mNativePointer is: "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/webkit/HTML5VideoViewProxy;->mNativePointer:I
    ...
    .line 866
    iget-boolean v1, p0, Landroid/webkit/HTML5VideoViewProxy;->mIsBuffering:Z
    ...
    .line 871
    :cond_1
    invoke-static {}, Landroid/webkit/HTML5VideoViewProxy$VideoPlayer;->stopVideoViewTimer()V
